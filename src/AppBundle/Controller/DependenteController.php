...
class DependenteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Dependente')->findAll();
     ...
     *
     * @Route("/", name="dependente_create")
     * @Method("POST")
     * @Template("AppBundle:Dependente:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Dependente')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="dependente_update")
     * @Method("PUT")
     * @Template("AppBundle:Dependente:edit.html.twig")
     */
