...
class DepartamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppBundle:Departamento')->findAll();
     ...
     * @Method("POST")
     * @Template("AppBundle:Departamento:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Departamento')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Departamento:edit.html.twig")
     */
